...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/udH3H2i4z/model.json',modelLoaded);
...
if(error){
    ...
    if(results[0].label == 'Happy'){
        document.getElementById('update_emoji'). innerHTML = '&#x1F601';
    }
    if(results[0].label == 'Sad'){
        document.getElementById('update_emoji'). innerHTML = '&#x1F614';
    }
    if(results[0].label == 'Angry'){
        document.getElementById('update_emoji'). innerHTML = '&#x1F621';
    }
    //depending on predictions in label 2 ,update the emojis accordingly in HTML
    if(results[1].label == 'Happy'){
        document.getElementById('update_emoji2'). innerHTML = '&#x1F601';
    }
    if(results[1].label == 'Sad'){
        document.getElementById('update_emoji2'). innerHTML = '&#x1F614';
    }
    if(results[1].label == 'Angry'){
        document.getElementById('update_emoji2'). innerHTML = '&#x1F621';
    }
